/* Amplify Params - DO NOT EDIT
	API_QUOTECARDGENERATOR_GRAPHQLAPIIDOUTPUT
	API_QUOTECARDGENERATOR_QUOTECARDGENERATORDATATABLE_ARN
	API_QUOTECARDGENERATOR_QUOTECARDGENERATORDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
const gradientsApiURL = "http://uigradients.com/gradients.json";
const width = 889;
...
const generateQuoteCard = async () => {
  ...
  const svgText = `
    ...
    <circle cx='${halfWidth}' cy='100' r='44' fill='rgba(255,255,255,0.155)' />
    <text  x='${halfWidth}' y='100' dy='60' text-anchor='middle' font-size='100' font-family='verdana' fill='white'>"</text>
    <g>
      
      <text id='quoteText' x='${halfWidth}' class='eachLineOfText' y='${goodStartY}' font-family='verdana' font-size='35'
      fill='white'>
      ${tspanElements}
      <tspan class='quoteAuthorStyle' x='${
        halfWidth - 25
      }' dy="1.8em" >- ${quoteAuthor}</tspan>
      </text>
    </g>
    <text x='${halfWidth}' y='${
    height - 35
  }' class='footerStyle'>Quotes from ZenQuotes | Powered by greybluesea</text>
    </svg>
 `;
 ...
 <defs>
         <linearGradient id="MyGradient">
           <stop offset="0%" stop-color="${selectedGradient.colors[0]}" />
           <stop offset="100%" stop-color="${selectedGradient.colors[1]}" />
         </linearGradient>
       </defs>
 <rect width="100%" height="100%" rx="3%" />
    ...
    case 3:
     ...
     <defs>
             <linearGradient id="MyGradient">
               <stop offset="0%" stop-color="${selectedGradient.colors[0]}" />
               <stop offset="50%" stop-color="${selectedGradient.colors[1]}" />
               <stop offset="100%" stop-color="${selectedGradient.colors[2]}" />
             </linearGradient>
           </defs>
     <rect width="100%" height="100%" rx="3%" />
     </svg>`;
    ...
    case 4:
     ...
     <defs>
             <linearGradient id="MyGradient">
               <stop offset="0%" stop-color="${selectedGradient.colors[0]}" />
               <stop offset="33%" stop-color="${selectedGradient.colors[1]}" />
               <stop offset="66%" stop-color="${selectedGradient.colors[2]}" />
               <stop offset="100%" stop-color="${selectedGradient.colors[3]}" />
             </linearGradient>
           </defs>
     <rect width="100%" height="100%" rx="3%" />
     </svg>`;
